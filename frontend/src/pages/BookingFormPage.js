        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {step === 2 && <><Building2 className="w-5 h-5" /> Property Selection</>}
            ...
            <CardDescription>
              ...
              {step === 2 && "Select your preferred property"}
                  ...
                  {formData.booking_amount && (
                    <div className="bg-slate-50 p-4 rounded-lg space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <p className="font-medium">₹{parseFloat(formData.booking_amount).toLocaleString('en-IN')}</p>
