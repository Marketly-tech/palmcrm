      ...
      <Card>
        <CardContent className="p-4">
          <div className="flex flex-col gap-4">
            ...
            {/* Quick Filter: Disbursement Overdue Button */}
            <div className="flex items-center gap-3">
              <Button
                variant={agreementFilter === "overdue" ? "default" : "outline"}
                size="sm"
              ...
              >
                ...
                {agreementFilter === "overdue" && (
                  <Badge variant="secondary" className="ml-2 bg-white text-red-600">{total}</Badge>
                )}
              </Button>
              
              {agreementFilter === "overdue" && (
                <span className="text-sm text-slate-500">
                  Showing customers with pending payments as per current disbursement slab
                </span>
              )}
            </div>
          </div>
